            ...
            <div className="grid mb-10 lg:grid-cols-2  md:grid-cols-2 grid-cols-1 ">
                <div className="grid mt-4">
                    <div className="m-auto">
                        <section style={userImageState !== false && userImageState !== null && userImageState !== '' ? { backgroundImage: `url(${userImageState})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", padding: "20px" } : { backgroundImage: "url(https://media.istockphoto.com/photos/abstract-wavy-object-picture-id1198271727?b=1&k=20&m=1198271727&s=170667a&w=0&h=b626WM5c-lq9g_yGyD0vgufb4LQRX9UgYNWPaNUVses=)", backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat", padding: "20px" }}>
                                    ...
                                    Array(4).fill().map((_, i) => (
                                        <div key={i} className="grid grid-cols-8 py-2" style={{ borderBottom: "1px solid #ffffff45 ", overflow: "hidden" }}>
                                            <div className="col-span-2">
                                                <div className="grid">
                                                    <img className="m-auto w-[50px] h-[50px] bg-white p-1 rounded-full " src="https://avatars.githubusercontent.com/u/70304119?v=4" alt="loading..." />
                                                </div>
                                            </div>
                ...
                <div className="grid lg:p-1 md:p-1 p-2">
                    <div className="m-auto">
                        ...
                        <div className="p-2 mt-3">
                            <button className='bg-blue-500 shadow-lg uppercase hover:shadow-blue-500/50 px-4 py-2 rounded text-base text-white' style={{ width: "100%", border: "1px solid  balck" }} onClick={() => copyDivToClipboard('codeBoard1', 'copybtn1')}>Copy</button>
                        </div>
                    </div>
                </div>
            </div>
